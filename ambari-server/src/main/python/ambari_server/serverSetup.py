  ...
  def __init__(self):
    ...
    self.JDK_DEFAULT_CONFIGS = [
      JDKRelease("jdk1.8", "Oracle JDK 1.8 + Java Cryptography Extension (JCE) Policy Files 8",
                 "http://archive.fusionlab.cn/jdp/artifacts/jdk-8u112-linux-x64.tar.gz", "jdk-8u112-linux-x64.tar.gz",
                 "http://archive.fusionlab.cn/jdp/artifacts/jce_policy-8.zip", "jce_policy-8.zip",
