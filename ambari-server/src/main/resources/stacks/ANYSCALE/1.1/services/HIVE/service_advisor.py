...
class HiveServiceAdvisor(service_advisor.ServiceAdvisor):
  ...
  def getServiceConfigurationRecommendations(self, configurations, clusterData, services, hosts):
    ...
    recommender.recommendHiveConfigurationsFromANYSCALE10(configurations, clusterData, services, hosts)
...
class HiveRecommender(service_advisor.ServiceAdvisor):
  ...
  def recommendHiveConfigurationsFromANYSCALE10(self, configurations, clusterData, services, hosts):
...
class HiveValidator(service_advisor.ServiceAdvisor):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.validators = [("hive-site", self.validateHiveConfigurationsFromANYSCALE10),
                       ("hive-env", self.validateHiveConfigurationsEnvFromANYSCALE10),
                       ("hiveserver2-site", self.validateHiveServer2ConfigurationsFromANYSCALE10),
                       ("hive-interactive-env", self.validateHiveInteractiveEnvConfigurationsFromANYSCALE10),
                       ("hive-interactive-site", self.validateHiveInteractiveSiteConfigurationsFromANYSCALE10)]


  def validateHiveConfigurationsFromANYSCALE10(self, properties, recommendedDefaults, configurations, services, hosts):
  ...
  def validateHiveConfigurationsEnvFromANYSCALE10(self, properties, recommendedDefaults, configurations, services, hosts):
    validationItems = []
  ...
  def validateHiveServer2ConfigurationsFromANYSCALE10(self, properties, recommendedDefaults, configurations, services, hosts):
  ...
  def validateHiveInteractiveEnvConfigurationsFromANYSCALE10(self, properties, recommendedDefaults, configurations, services, hosts):
  ...
  def validateHiveInteractiveSiteConfigurationsFromANYSCALE10(self, properties, recommendedDefaults, configurations, services, hosts):
    """
