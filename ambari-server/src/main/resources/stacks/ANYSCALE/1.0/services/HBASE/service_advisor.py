...
class HBASEServiceAdvisor(service_advisor.ServiceAdvisor):
  ...
  def getServiceConfigurationRecommendations(self, configurations, clusterData, services, hosts):
    ...
    recommender.recommendHBASEConfigurationsFromANYSCALE10(configurations, clusterData, services, hosts)
    recommender.recommendHBASEConfigurationsFromANYSCALE101(configurations, clusterData, services, hosts)
...
class HBASERecommender(service_advisor.ServiceAdvisor):
  ...
  def recommendHBASEConfigurationsFromANYSCALE10(self, configurations, clusterData, services, hosts):
  ...
  def recommendHBASEConfigurationsFromANYSCALE101(self, configurations, clusterData, services, hosts):
    # Setters
    putHbaseSiteProperty = self.putProperty(configurations, "hbase-site", services)
    putHbaseEnvProperty = self.putProperty(configurations, "hbase-env", services)
