...
def seed_current_data_directory():
  ...
  /opt/anyscale/2.2.0.0-1234/knox/data -> /var/lib/knox/data
  /opt/anyscale/2.3.0.0-4567/knox/data -> /var/lib/knox/data-2.3.0.0-4567
  ...
  cp -R -p -f /opt/anyscale/<old>/knox-server/data/. /opt/anyscale/current/knox-server/data
  :return:
  """
  import params
