...
class Spark2ServiceAdvisor(service_advisor.ServiceAdvisor):
  ...
  def getServiceConfigurationRecommendations(self, configurations, clusterData, services, hosts):
    ...
    recommender.recommendSPARK2ConfigurationsFromANYSCALE10(configurations, clusterData, services, hosts)
...
class Spark2Recommender(service_advisor.ServiceAdvisor):
  ...
  def recommendSPARK2ConfigurationsFromANYSCALE10(self, configurations, clusterData, services, hosts):
    ...
    if "spark2-atlas-application-properties-override" in services["configurations"]:
      ...
      if spark2_sac_enabled:
        ...
        self.setOrAddValueToProperty(putSpark2DefautlsProperty, spark2_defaults_properties, "spark.driver.extraClassPath", "/opt/anyscale/current/spark-atlas-connector/*", ":")
        ...
        self.setOrAddValueToProperty(putSpark2ThriftSparkConfProperty, spark2_thriftspark_conf_properties, "spark.driver.extraClassPath", "/opt/anyscale/current/spark-atlas-connector/*", ":")
        ...
        self.removeValueFromProperty(putSpark2DefautlsProperty, spark2_defaults_properties, "spark.driver.extraClassPath", "/opt/anyscale/current/spark-atlas-connector/*", ":")
        ...
        self.removeValueFromProperty(putSpark2ThriftSparkConfProperty, spark2_thriftspark_conf_properties, "spark.driver.extraClassPath", "/opt/anyscale/current/spark-atlas-connector/*", ":")
...
class Spark2Validator(service_advisor.ServiceAdvisor):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.validators = [("spark2-defaults", self.validateSpark2DefaultsFromHDP25),
                       ...
                       ("spark2-atlas-application-properties-override", self.validateSpark2AtlasApplicationPropertiesFromANYSCALE10)]
  ...
  def validateSpark2AtlasApplicationPropertiesFromANYSCALE10(self, properties, recommendedDefaults, configurations, services, hosts):
    validationItems = []
