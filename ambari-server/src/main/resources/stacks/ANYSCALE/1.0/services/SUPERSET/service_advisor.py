...
class SupersetServiceAdvisor(service_advisor.ServiceAdvisor):
  ...
  def getServiceConfigurationRecommendations(self, configurations, clusterData, services, hosts):
    ...
    recommender.recommendSupersetConfigurationsFromANYSCALE10(configurations, clusterData, services, hosts)
...
class SupersetRecommender(service_advisor.ServiceAdvisor):
  ...
  def recommendSupersetConfigurationsFromANYSCALE10(self, configurations, clusterData, services, hosts):
