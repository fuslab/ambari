...
class StormServiceAdvisor(service_advisor.ServiceAdvisor):
    ...
    def getServiceConfigurationRecommendations(self, configurations, clusterData, services, hosts):
        ...
        recommender.recommendStormConfigurationsFromANYSCALE10(configurations, clusterData, services, hosts)
...
class StormRecommender(service_advisor.ServiceAdvisor):
    ...
    def recommendStormConfigurationsFromANYSCALE10(self, configurations, clusterData, services, hosts):
