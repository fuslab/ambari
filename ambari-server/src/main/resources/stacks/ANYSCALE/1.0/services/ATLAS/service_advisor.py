...
class AtlasValidator(service_advisor.ServiceAdvisor):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.validators = [("application-properties", self.validateAtlasConfigurationsFromHDP25),
                       ("atlas-env", self.validateAtlasConfigurationsFromANYSCALE10)]
  ...
  def validateAtlasConfigurationsFromANYSCALE10(self, properties, recommendedDefaults, configurations, services, hosts):
    validationItems = []
