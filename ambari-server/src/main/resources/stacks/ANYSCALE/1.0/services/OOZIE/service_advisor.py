...
class OozieServiceAdvisor(service_advisor.ServiceAdvisor):
  ...
  def getServiceConfigurationRecommendations(self, configurations, clusterData, services, hosts):
    ...
    recommender.recommendOozieConfigurationsFromANYSCALE10(configurations, clusterData, services, hosts)
...
class OozieRecommender(service_advisor.ServiceAdvisor):
  ...
  def recommendOozieConfigurationsFromANYSCALE10(self, configurations, clusterData, services, hosts):
    ## added in 2.0.6
