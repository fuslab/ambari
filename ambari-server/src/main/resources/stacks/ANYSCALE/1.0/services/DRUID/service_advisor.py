...
class DruidServiceAdvisor(service_advisor.ServiceAdvisor):
  ...
  def getServiceConfigurationRecommendations(self, configurations, clusterData, services, hosts):
    ...
    recommender.recommendDruidConfigurationsFromANYSCALE10(configurations, clusterData, services, hosts)
...
class DruidRecommender(service_advisor.ServiceAdvisor):
  ...
  def recommendDruidConfigurationsFromANYSCALE10(self, configurations, clusterData, services, hosts):
...
class DruidValidator(service_advisor.ServiceAdvisor):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.validators = [("druid-env", self.validateDruidEnvConfigurationsFromANYSCALE10),
                       ("druid-historical", self.validateDruidHistoricalConfigurationsFromANYSCALE10),
                       ("druid-broker", self.validateDruidBrokerConfigurationsFromANYSCALE10)]

  def validateDruidEnvConfigurationsFromANYSCALE10(self, properties, recommendedDefaults, configurations, services, hosts):
      validationItems = []
  ...
  def validateDruidHistoricalConfigurationsFromANYSCALE10(self, properties, recommendedDefaults, configurations, services, hosts):
      validationItems = [
  ...
  def validateDruidBrokerConfigurationsFromANYSCALE10(self, properties, recommendedDefaults, configurations, services, hosts):
        validationItems = [
            {"config-name": "druid.processing.numThreads",
             "item": self.validatorEqualsToRecommendedItem(properties, recommendedDefaults,
                                                           "druid.processing.numThreads")}
