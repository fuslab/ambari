...
class Ranger_KMSServiceAdvisor(service_advisor.ServiceAdvisor):
  ...
  def getServiceConfigurationRecommendations(self, configurations, clusterData, services, hosts):
    ...
    recommender.recommendRangerKMSConfigurationsFromANYSCALE10(configurations, clusterData, services, hosts)
...
class RangerKMSRecommender(service_advisor.ServiceAdvisor):
  ...
  def recommendRangerKMSConfigurationsFromANYSCALE10(self, configurations, clusterData, services, hosts):
    putRangerKmsEnvProperty = self.putProperty(configurations, "kms-env", services)
