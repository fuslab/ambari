...
class KafkaServiceAdvisor(service_advisor.ServiceAdvisor):
  ...
  def getServiceConfigurationRecommendations(self, configurations, clusterData, services, hosts):
    ...
    recommender.recommendKAFKAConfigurationsFromANYSCALE10(configurations, clusterData, services, hosts)
...
class KafkaRecommender(service_advisor.ServiceAdvisor):
  ...
  def recommendKAFKAConfigurationsFromANYSCALE10(self, configurations, clusterData, services, hosts):
...
class KafkaValidator(service_advisor.ServiceAdvisor):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.validators = [("ranger-kafka-plugin-properties", self.validateKafkaRangerPluginConfigurationsFromHDP22),
                       ...
                       ("kafka-broker", self.validateKAFKAConfigurationsFromANYSCALE10)]
  ...
  def validateKAFKAConfigurationsFromANYSCALE10(self, properties, recommendedDefaults, configurations, services, hosts):
    kafka_broker = properties
    validationItems = []
    servicesList = [service["StackServices"]["service_name"] for service in services["services"]]
    kafka_broker_properties = self.getSiteProperties(configurations, "kafka-broker")
