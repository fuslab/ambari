...
class TezServiceAdvisor(service_advisor.ServiceAdvisor):
  ...
  def getServiceConfigurationRecommendations(self, configurations, clusterData, services, hosts):
    ...
    recommender.recommendTezConfigurationsFromANYSCALE10(configurations, clusterData, services, hosts)
...
class TezRecommender(service_advisor.ServiceAdvisor):
  ...
  def recommendTezConfigurationsFromANYSCALE10(self, configurations, clusterData, services, hosts):
    putTezProperty = self.putProperty(configurations, "tez-site")
