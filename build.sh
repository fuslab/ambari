...
if [ $mode == "all" ]; then
	echo 'Run mode: ' $mode
	mvn -B clean install package rpm:rpm -DnewVersion=2.7.4.0.0 -Dstack.distribution=HDP -DbuildNumber=631319b00937a8d04667d93714241d2a0cb17275 -DskipTests -DskipTests -Dpython.ver="python >= 2.6" -Drat.skip -Preplaceurl
fi
